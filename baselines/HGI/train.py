...
def parse_args():
    ...
    parser.add_argument('--city', type=str, default='beijing', help='city name, such as shenzhen')
    ...
    parser.add_argument('--mode', type=str, choices=['original','filtered'], default='original', help='Choose the mode ("original", "filtered")')
...
if __name__ == '__main__':
    ...
    data = hgi_graph(args.city, args.mode).to(args.device)
    """load the Module"""
    ...
    if args.mode == 'original':
        torch.save(region_emb_to_save, f'./Emb/{args.city}_emb')
        print(f"Region embeddings of {args.city} has been save to ./Emb/{args.city}_emb")
    elif args.mode == 'filtered':
        torch.save(region_emb_to_save, f'./Emb/{args.city}_BM25_keywords_kmeans_emb')
        print(f"Region embeddings of {args.city} has been save to ./Emb/{args.city}_BM25_keywords_kmeans_emb")
    else:
